...
def main():
    ...
    teaching_set = './datasets/butterflies_crop/' + args.selection + '/butterflies_Lt_gt_s300_CE_simclr_tr.txt'
    remaining_set = './datasets/butterflies_crop/' + args.selection + '/butterflies_Dt_gt_s300_tr.txt'
    remaining_set_CE = './datasets/butterflies_crop/' + args.selection + '/butterflies_Dt_gt_s300_CE_simclr_tr.txt'
    ...
    for iter in range(args.iters):
        ...
        if iter == 0:
            ...
            counterlist_CE = []
            indexlist = []
            with open('./datasets/butterflies_crop/butterflies_gt_s300_CE_simclr.txt', 'r') as rf:
                for line in rf.readlines():
            ...
            assert callable(datasets.__dict__['butterflies_s300_wo_shuffle'])
            get_dataset = getattr(datasets, 'butterflies_s300_wo_shuffle')
            num_classes = datasets._NUM_CLASSES['butterflies_s300_wo_shuffle']
            train_loader, val_loader = get_dataset(
                batch_size=1, num_workers=args.workers)

            assert callable(datasets.__dict__['butterflies_s300_CE_simclr'])
            get_dataset = getattr(datasets, 'butterflies_s300_CE_simclr')
            num_classes = datasets._NUM_CLASSES['butterflies_s300_CE_simclr']
            ...
            assert callable(datasets.__dict__['butterflies_Dt'])
            get_dataset = getattr(datasets, 'butterflies_Dt')
            num_classes = datasets._NUM_CLASSES['butterflies_Dt']
            train_loader_Dt, val_loader = get_dataset(
                batch_size=1, num_workers=args.workers, selection=args.selection)

            assert callable(datasets.__dict__['butterflies_s300_CE_simclr_Dt'])
            get_dataset = getattr(datasets, 'butterflies_s300_CE_simclr_Dt')
            num_classes = datasets._NUM_CLASSES['butterflies_s300_CE_simclr_Dt']
            train_loader_CE_Dt, val_loader_CE = get_dataset(
                batch_size=1, num_workers=args.workers, selection=args.selection)
            ...
            assert callable(datasets.__dict__['butterflies_s300_CE_simclr_Lt'])
            get_dataset = getattr(datasets, 'butterflies_s300_CE_simclr_Lt')
            num_classes = datasets._NUM_CLASSES['butterflies_s300_CE_simclr_Lt']
    ...
    np.save('./butterflies/all_train_acc_iter_' + args.selection + '_imagenet_CE_simclr.npy', all_train_acc_iter)
    np.save('./butterflies/all_test_acc_iter_' + args.selection + '_imagenet_CE_simclr.npy', all_test_acc_iter)
